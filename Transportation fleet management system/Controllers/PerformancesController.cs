...
namespace Transportation_fleet_management_system.Controllers
{
    public class PerformancesController : Controller
    {
        ...
        public PerformancesController(Transportation_fleet_management_systemContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("PerformanceId,ReportType,Data,GeneratedOn")] Performance performance)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PerformanceId,ReportType,Data,GeneratedOn")] Performance performance)
        {
